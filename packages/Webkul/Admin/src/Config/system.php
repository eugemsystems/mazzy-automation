...
return [
    ...
    [
        ...
        'key'    => 'sales.carriers.zone_rate',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.zone-rate-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.zone-rate-shipping.title-info',
        'sort'   => 3,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.zone-rate-shipping.title',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.zone-rate-shipping.description',
                'type'          => 'textarea',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'active',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.zone-rate-shipping.status',
                'type'          => 'boolean',
                'channel_based' => true,
                'locale_based'  => false,
            ],
        ...
        'key' => 'sales.payment_methods.netcash',
        'name' => 'admin::app.configuration.index.sales.payment-methods.netcash',
        'info' => 'admin::app.configuration.index.sales.payment-methods.netcash-info',
        'sort' => 8,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'service_key',
                'title' => 'admin::app.configuration.index.sales.payment-methods.netcash-service-key',
                'info' => 'admin::app.configuration.index.sales.payment-methods.netcash-service-key-info',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'netcash_urls_notice',
                'title' => 'admin::app.configuration.index.sales.payment-methods.netcash-urls-notice',
                'type' => 'blade',
                'path' => 'admin::configuration.custom-views.netcash-urls-notice',
                'depends' => 'active:1',
            ], [
                'name' => 'sort',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sort-order',
