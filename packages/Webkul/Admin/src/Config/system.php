...
return [
    ...
    [
        ...
        'key'    => 'sales.carriers.province_rate',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.title-info',
        'sort'   => 3,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.title',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.description',
                'type'          => 'textarea',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'default_rate',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.default-rate',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1|numeric',
                'channel_based' => true,
                ...
                'name'          => 'rate_ec',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.eastern-cape',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_fs',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.free-state',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_gp',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.gauteng',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_kn',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.kwazulu-natal',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_lp',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.limpopo',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_mp',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.mpumalanga',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_nc',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.northern-cape',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_nw',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.north-west',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'rate_wc',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.provinces.western-cape',
                'type'          => 'text',
                'depends'       => 'active:1',
                'channel_based' => true,
                'locale_based'  => false,
                ...
                'name'          => 'active',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.province-rate-shipping.status',
                'type'          => 'boolean',
                'channel_based' => true,
                'locale_based'  => false,
            ],
        ...
        'key'    => 'sales.carriers.collection_point',
        'name'   => 'admin::app.configuration.index.sales.shipping-methods.collection-point-shipping.page-title',
        'info'   => 'admin::app.configuration.index.sales.shipping-methods.collection-point-shipping.title-info',
        'sort'   => 4,
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.collection-point-shipping.title',
                'type'          => 'text',
                'depends'       => 'active:1',
                'validation'    => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name'          => 'description',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.collection-point-shipping.description',
                'type'          => 'textarea',
                'channel_based' => true,
                'locale_based'  => true,
            ], [
                'name'          => 'active',
                'title'         => 'admin::app.configuration.index.sales.shipping-methods.collection-point-shipping.status',
                'type'          => 'boolean',
                'channel_based' => true,
                'locale_based'  => false,
            ],
