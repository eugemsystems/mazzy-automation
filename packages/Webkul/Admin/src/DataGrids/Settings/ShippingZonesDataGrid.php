...
class ShippingZonesDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            'index' => 'code',
            'label' => trans('admin::app.settings.shipping-zones.index.datagrid.code'),
            'type' => 'string',
            'searchable' => true,
            'filterable' => true,
            'sortable' => true,
        ...
        $this->addColumn([
            ...
            'closure' => function ($row) {
                if ($row->status) {
                    return trans('admin::app.settings.shipping-zones.index.datagrid.active');
                }

                return trans('admin::app.settings.shipping-zones.index.datagrid.inactive');
            },
        ]);
    }
