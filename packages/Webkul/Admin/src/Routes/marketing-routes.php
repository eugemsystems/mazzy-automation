...
use Webkul\Admin\Http\Controllers\Marketing\Communications\EnquiryController;
...
Route::prefix('marketing')->group(function () {
    ...
    Route::prefix('communications')->group(function () {
        ...
        /**
         * Form submissions (enquiries & quotes) routes.
         */
        Route::controller(EnquiryController::class)->prefix('enquiries')->group(function () {
            Route::get('', 'index')->name('admin.marketing.communications.enquiries.index');

            Route::delete('{id}', 'destroy')->name('admin.marketing.communications.enquiries.delete');
        });
