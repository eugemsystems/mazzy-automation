        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'آدرس پذیرش',
                    'decline-url' => 'آدرس رد',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now به مشتریان امکان می‌دهد از طریق صفحه پرداخت میزبانی‌شده Netcash با کارت یا EFT پرداخت کنند.',
                    'netcash-service-key' => 'کلید سرویس Pay Now',
                    'netcash-service-key-info' => 'در حساب Netcash شما تحت Account Profile → NetConnector → Pay Now قابل یافتن است.',
                    'netcash-urls-notice' => 'آدرس‌های بازگشتی Netcash',
                    'netcash-urls-notice-info' => 'قبل از راه‌اندازی نهایی، این آدرس‌ها را در حساب Netcash خود تحت Account Profile → NetConnector → Pay Now کپی کنید.',
                    'notify-url' => 'آدرس اطلاع‌رسانی',
