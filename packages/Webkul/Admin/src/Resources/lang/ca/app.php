        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'URL d\'acceptació',
                    'decline-url' => 'URL de rebuig',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now permet als clients pagar amb targeta o transferència EFT mitjançant la pàgina de pagament allotjada de Netcash.',
                    'netcash-service-key' => 'Clau de servei de Pay Now',
                    'netcash-service-key-info' => 'Es troba al vostre compte de Netcash a Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'URLs de retorn de Netcash',
                    'netcash-urls-notice-info' => 'Copieu aquests URLs al vostre compte de Netcash a Account Profile → NetConnector → Pay Now abans de posar-ho en producció.',
                    'notify-url' => 'URL de notificació',
