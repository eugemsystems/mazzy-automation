        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'URL подтверждения',
                    'decline-url' => 'URL отказа',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now позволяет клиентам оплачивать картой или банковским переводом (EFT) через хостинговую страницу оплаты Netcash.',
                    'netcash-service-key' => 'Сервисный ключ Pay Now',
                    'netcash-service-key-info' => 'Находится в вашем аккаунте Netcash в разделе Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'URL обратных вызовов Netcash',
                    'netcash-urls-notice-info' => 'Скопируйте эти URL в ваш аккаунт Netcash в разделе Account Profile → NetConnector → Pay Now перед переходом в рабочий режим.',
                    'notify-url' => 'URL уведомления',
