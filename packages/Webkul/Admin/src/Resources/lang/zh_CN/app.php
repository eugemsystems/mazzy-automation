        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'decline-url' => '拒绝 URL',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now 允许客户通过 Netcash 托管的支付页面使用卡或 EFT 付款。',
                    'netcash-service-key' => 'Pay Now 服务密钥',
                    'netcash-service-key-info' => '可在您的 Netcash 账户的 Account Profile → NetConnector → Pay Now 中找到。',
                    'netcash-urls-notice' => 'Netcash 回调 URL',
                    'netcash-urls-notice-info' => '上线前，请将这些 URL 复制到您的 Netcash 账户的 Account Profile → NetConnector → Pay Now 中。',
                    'notify-url' => '通知 URL',
                    'page-title' => '支付方式',
                    'paid' => '已支付',
