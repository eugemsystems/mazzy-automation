        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'URL d\'acceptation',
                    'decline-url' => 'URL de refus',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now permet aux clients de payer par carte ou par EFT via la page de paiement hébergée de Netcash.',
                    'netcash-service-key' => 'Clé de service Pay Now',
                    'netcash-service-key-info' => 'Disponible dans votre compte Netcash sous Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'URLs de rappel Netcash',
                    'netcash-urls-notice-info' => 'Copiez ces URLs dans votre compte Netcash sous Account Profile → NetConnector → Pay Now avant la mise en production.',
