        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'URL de aceptación',
                    'decline-url' => 'URL de rechazo',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now permite a los clientes pagar con tarjeta o EFT a través de la página de pago alojada de Netcash.',
                    'netcash-service-key' => 'Clave de servicio de Pay Now',
                    'netcash-service-key-info' => 'Se encuentra en su cuenta de Netcash en Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'URLs de retorno de Netcash',
                    'netcash-urls-notice-info' => 'Copie estas URLs en su cuenta de Netcash en Account Profile → NetConnector → Pay Now antes de pasar a producción.',
                    'notify-url' => 'URL de notificación',
