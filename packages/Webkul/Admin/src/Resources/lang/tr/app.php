        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'Kabul URL\'si',
                    'decline-url' => 'Reddetme URL\'si',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now, müşterilerin Netcash\'in barındırılan ödeme sayfası üzerinden kart veya EFT ile ödeme yapmasını sağlar.',
                    'netcash-service-key' => 'Pay Now Servis Anahtarı',
                    'netcash-service-key-info' => 'Netcash hesabınızda Account Profile → NetConnector → Pay Now altında bulunur.',
                    'netcash-urls-notice' => 'Netcash Geri Çağırma URL\'leri',
                    'netcash-urls-notice-info' => 'Canlıya geçmeden önce bu URL\'leri Netcash hesabınızda Account Profile → NetConnector → Pay Now altına kopyalayın.',
                    'notify-url' => 'Bildirim URL\'si',
