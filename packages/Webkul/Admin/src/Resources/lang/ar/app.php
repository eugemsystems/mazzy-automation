        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'رابط القبول',
                    'decline-url' => 'رابط الرفض',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'تتيح خدمة Netcash Pay Now للعملاء الدفع بالبطاقة أو التحويل المصرفي عبر صفحة الدفع المستضافة من Netcash.',
                    'netcash-service-key' => 'مفتاح خدمة Pay Now',
                    'netcash-service-key-info' => 'يوجد في حساب Netcash الخاص بك ضمن Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'روابط استدعاء Netcash',
                    'netcash-urls-notice-info' => 'انسخ هذه الروابط إلى حساب Netcash الخاص بك ضمن Account Profile → NetConnector → Pay Now قبل التشغيل الفعلي.',
                    'notify-url' => 'رابط الإشعار',
