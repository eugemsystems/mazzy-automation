        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'decline-url' => '拒否URL',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Nowを使用すると、顧客はNetcashのホスト型決済ページを通じてカードまたはEFTで支払うことができます。',
                    'netcash-service-key' => 'Pay Now サービスキー',
                    'netcash-service-key-info' => 'Netcashアカウントの Account Profile → NetConnector → Pay Now にあります。',
                    'netcash-urls-notice' => 'Netcash コールバックURL',
                    'netcash-urls-notice-info' => '本番運用前に、これらのURLをNetcashアカウントの Account Profile → NetConnector → Pay Now にコピーしてください。',
                    'notify-url' => '通知URL',
                    'page-title' => '支払い方法',
                    'paid' => '支払済み',
