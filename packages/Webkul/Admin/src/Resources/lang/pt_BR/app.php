        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'URL de Aceitação',
                    'decline-url' => 'URL de Recusa',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'O Netcash Pay Now permite que os clientes paguem com cartão ou EFT por meio da página de pagamento hospedada da Netcash.',
                    'netcash-service-key' => 'Chave de Serviço do Pay Now',
                    'netcash-service-key-info' => 'Encontrada na sua conta Netcash em Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'URLs de Callback da Netcash',
                    'netcash-urls-notice-info' => 'Copie essas URLs para sua conta Netcash em Account Profile → NetConnector → Pay Now antes de entrar em produção.',
