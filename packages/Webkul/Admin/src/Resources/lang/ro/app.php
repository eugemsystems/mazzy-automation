        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'accept-url' => 'URL de acceptare',
                    'decline-url' => 'URL de refuz',
                    'netcash' => 'Netcash',
                    'netcash-info' => 'Netcash Pay Now permite clienților să plătească prin card sau EFT prin pagina de plată găzduită de Netcash.',
                    'netcash-service-key' => 'Cheia de serviciu Pay Now',
                    'netcash-service-key-info' => 'Se găsește în contul dvs. Netcash la Account Profile → NetConnector → Pay Now.',
                    'netcash-urls-notice' => 'URL-uri de callback Netcash',
                    'netcash-urls-notice-info' => 'Copiați aceste URL-uri în contul dvs. Netcash la Account Profile → NetConnector → Pay Now înainte de lansare.',
                    'notify-url' => 'URL de notificare',
