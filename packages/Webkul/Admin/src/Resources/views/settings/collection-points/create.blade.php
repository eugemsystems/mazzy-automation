<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.settings.collection-points.create.add-title')
    </x-slot>

    {!! view_render_event('bagisto.admin.settings.collection_points.create.before') !!}

    <x-admin::form :action="route('admin.settings.collection_points.store')">

        {!! view_render_event('bagisto.admin.settings.collection_points.create.create_form_controls.before') !!}
        ...
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('admin::app.settings.collection-points.create.back-btn')
                </a>

                <!-- Save Button -->
                <button type="submit" class="primary-button">
                    @lang('admin::app.settings.collection-points.create.save-btn')
                </button>
            </div>
        </div>
        ...
        {!! view_render_event('bagisto.admin.settings.collection_points.create.create_form_controls.after') !!}

    </x-admin::form>

    {!! view_render_event('bagisto.admin.settings.collection_points.create.after') !!}
