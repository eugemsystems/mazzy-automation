<x-admin::layouts>
    ...
    <x-admin::form :action="route('admin.settings.shipping_zones.store')">
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('admin::app.settings.shipping-zones.create.back-btn')
                </a>

                <button type="submit" class="primary-button">
                    @lang('admin::app.settings.shipping-zones.create.save-btn')
                </button>
            </div>
        </div>
                        ...
                        @foreach ($provinces as $province)
                            <label class="flex cursor-pointer items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                <input
                                    ...
                                    name="provinces[]"
                                    value="{{ $province->code }}"
                                    {{ in_array($province->code, old('provinces', [])) ? 'checked' : '' }}
                                >
