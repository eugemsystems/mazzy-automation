<x-admin::layouts>
    <x-slot:title>
        @lang('admin::app.settings.shipping-classes.edit.title')
    </x-slot>

    <x-admin::form
        :action="route('admin.settings.shipping_classes.update', $shippingClass->id)"
        method="PUT"
    >
        <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                >
                    @lang('admin::app.settings.shipping-classes.edit.back-btn')
                </a>

                <button type="submit" class="primary-button">
                    @lang('admin::app.settings.shipping-classes.edit.save-btn')
                </button>
            </div>
        </div>
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group.control
                            ...
                            name="code"
                            rules="required"
                            :value="old('code') ?? $shippingClass->code"
                    ...
                    <x-admin::form.control-group class="!mb-0">
                        ...
                        <x-admin::form.control-group.control
                            type="textarea"
                            name="description"
                            :value="old('description') ?? $shippingClass->description"
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group class="!mb-0">
                        ...
                        <x-admin::form.control-group.control
                            ...
                            :checked="(bool) (old('status') ?? $shippingClass->status)"
                        />
                    </x-admin::form.control-group>
                </div>
            </div>
