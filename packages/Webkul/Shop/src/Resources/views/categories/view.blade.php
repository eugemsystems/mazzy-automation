...
<x-shop::layouts>
    ...
    <div style="background:#332a5e; padding:28px 0 22px;">
        <div class="container">
            <h1 style="color:#fff; font-size:22px; font-weight:700; margin:0 0 6px;">{{ $category->name }}</h1>
            <nav style="font-size:13px;">
                ...
                <span style="color:rgba(255,255,255,.4); margin:0 8px;">/</span>
                <span style="color:#FF9923;">{{ $category->name }}</span>
            </nav>
        </div>
    </div>
    ...
    {{-- Category banner image (below breadcrumb) --}}
