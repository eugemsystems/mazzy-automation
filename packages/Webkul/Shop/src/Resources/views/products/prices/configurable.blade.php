...
@if (isset($prices['final']) && $prices['final']['price'] < $prices['regular']['price'])
    <p class="regular-price text-lg font-semibold text-slate-500 line-through max-sm:text-sm max-sm:leading-4">
...
@else
    <p class="regular-price text-lg font-semibold text-slate-500 line-through max-sm:text-sm max-sm:leading-4" style="display: none;"></p>
