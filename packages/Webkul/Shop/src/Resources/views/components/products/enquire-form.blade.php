...
<form @submit.prevent="sendEnquiry()">
    ...
    <div class="mb-3">
        ...
        <input
            ...
            required
            class="w-full rounded-md border border-slate-200 px-2.5 py-1.5 text-sm text-slate-700 focus:border-slate-400 focus:outline-none"
        >
    </div>
    ...
    <button
        type="submit"
        class="w-full max-w-full rounded-lg bg-[#332a5e] px-4 py-2 text-sm text-white transition-colors hover:bg-[#FF9923] disabled:cursor-not-allowed disabled:opacity-50"
