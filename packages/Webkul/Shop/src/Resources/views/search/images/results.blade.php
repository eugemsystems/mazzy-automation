...
@pushOnce('scripts')
    ...
    >
        <div class="mt-8 rounded-lg border border-gray-200 bg-gray-100 p-5 max-sm:mt-0 max-sm:grid max-sm:gap-y-2.5 max-sm:p-2.5">
            <div class="flex gap-12 max-sm:items-center max-sm:gap-4">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap gap-5 max-sm:hidden">
                        <span 
                            class="flex cursor-pointer items-center justify-center rounded-full border border-[#332a5e] px-4 py-1.5 font-medium text-[#332a5e]"
                            :class="{'rounded-full bg-[#332a5e] text-white': term.name.trim() === queryParameter.trim()}"
            ...
            <div class="hidden flex-wrap gap-2 max-sm:flex">
                <span 
                    class="flex cursor-pointer items-center justify-center rounded-full border border-[#332a5e] bg-white font-medium text-[#332a5e]"
                    v-for="term in searchedTerms"
                    @click="search(term)"
                >
                    <span
